...
function default_middleware_stack()
    return AbstractMiddleware[SessionMiddleware(), SessionOpsMiddleware(), DescribeMiddleware(), PingMiddleware(), InterruptMiddleware(), StdinMiddleware(), EvalMiddleware(), ReloadFileMiddleware(), LoadFileMiddleware(), CompleteMiddleware(), LookupMiddleware(), UnknownOpMiddleware()]
end
